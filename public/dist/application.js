...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('saleitems');
'use strict';
...
/*		var sellerOption = function(user) {
			if (user) {
				if (typeof(this.buyerSeller) === 'undefined') {
					return true;
				} else if(this.buyerSeller === user.buyerSeller){
					return true;
				} else {
					return false;
				}
...
angular.module('users').controller('AuthenticationController', ['$scope', '$http', '$location', 'Authentication',
	function($scope, $http, $location, Authentication) {
		...
		$scope.signup = function() {
			...
			//Add the buyer/seller property into the roles array
			$scope.credentials.roles = [$scope.credentials.buyerSeller]; 
